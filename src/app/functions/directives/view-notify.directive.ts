...
export class ViewNotifyDirective implements AfterViewInit, OnDestroy {
  @Output()
  viewnotify: EventEmitter<void>;
  ...
  constructor(private element: ElementRef){
    this.viewnotify = new EventEmitter<void>();
  }
